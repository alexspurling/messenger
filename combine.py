...
#     img3 = cv2.imread(image3, cv2.IMREAD_GRAYSCALE)
#
#     img1 = adjust_exposure(img1, image1exposure, 30)
#     img2 = adjust_exposure(img2, image2exposure, 30)
#     img3 = adjust_exposure(img3, image3exposure, 30)
#
#     # if frame_num == 19:
...
#         output_image = f"frames/frame{frame_num}.png"
#
#         red_xml = "MSGRMDS_1001/DATA/2005_214/" + all_images[red_image_idx].removesuffix(".tif") + ".xml"
#         green_xml = "MSGRMDS_1001/DATA/2005_214/" + all_images[green_image_idx].removesuffix(".tif") + ".xml"
#         blue_xml = "MSGRMDS_1001/DATA/2005_214/" + all_images[blue_image_idx].removesuffix(".tif") + ".xml"
#
